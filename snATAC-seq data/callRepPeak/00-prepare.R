...
geneAnnotation <- readRDS('/cluster/share/atac_group/mafas5/chen_ws/macaca_geneAnnotation.Rds')
...
blacklist=read.table('/cluster/share/atac_group/mafas5/ref/macFas5.huada.backlist.bed',header = F,stringsAsFactors = FALSE)
